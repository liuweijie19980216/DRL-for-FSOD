...
def parse_args():
    ...
    parser.add_argument('--save', dest='save_dir',
                        ...
                        type=str)
    parser.add_argument('--temperture', dest='temperture', default=1,
    ...
    with torch.no_grad():
        for i in range(num_images):
            ...
            if vis:
                ...
                #im = cv2.imread(imdb.image_path_from_index_vis(int(data[4])))
                im2show = np.copy(im)
            ...
            if vis:
                import os
                vis_path = '/home/liuwj/Repository/FSOD/FSOD_pascal/vis'
                im_dir = os.path.join(vis_path, str(data[4].numpy()[0]) + '_det.png')
